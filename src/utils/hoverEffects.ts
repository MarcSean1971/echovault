...
export const BUTTON_HOVER_EFFECTS = {
  default: "hover:opacity-90 hover:shadow-sm active:scale-[0.98]",
  primary: "hover:opacity-90 hover:shadow-sm active:scale-[0.98]",
  secondary: "hover:opacity-90 hover:shadow-sm active:scale-[0.98]",
  destructive: "hover:opacity-90 hover:shadow-sm active:scale-[0.98]",
...
// Icon hover effects
export const ICON_HOVER_EFFECTS = "hover:opacity-90 transition-all duration-200";

// Card hover effects
export const CARD_HOVER_EFFECTS = "hover:shadow-md transition-shadow duration-200";

// Dropdown item hover effects
export const DROPDOWN_HOVER_EFFECTS = "hover:opacity-90 transition-opacity";
