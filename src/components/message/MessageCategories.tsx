    ...
    <>
      ...
      {panicMessages.length > 0 && (
        <div className="mb-8 animate-fade-in rounded-lg">
          <h2 className="text-xl font-semibold mb-4 bg-gradient-to-r from-destructive to-destructive/70 text-transparent bg-clip-text flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 mr-2 text-destructive ${HOVER_TRANSITION}`}>
      ...
      <div className={panicMessages.length > 0 ? "mt-6 animate-fade-in" : "animate-fade-in"}>
        {panicMessages.length > 0 && (
          <h2 className="text-xl font-semibold mb-4 bg-gradient-to-r from-primary to-primary/70 text-transparent bg-clip-text flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 mr-2 text-primary ${HOVER_TRANSITION}`}>
