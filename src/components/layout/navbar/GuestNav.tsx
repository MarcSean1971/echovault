...
export function GuestNav() {
  return (
    <div className="flex items-center space-x-3">
      ...
      <Button 
        asChild 
        className="bg-gradient-to-r from-primary to-accent hover:opacity-90 transition-opacity shadow-sm hover:shadow-md"
      >
      ...
      <Sheet>
        <SheetTrigger asChild>
          <Button variant="ghost" size="icon" className="sm:hidden rounded-full hover:bg-accent/10">
